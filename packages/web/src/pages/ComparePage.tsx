...
const ROWS: Row[] = [
  ...
  { label: 'Fare quality', value: (j) => j.deal.percentBelowReference, render: (j) => <DealBadge level={j.deal.level} />, best: 'max' },
  { label: 'Saving vs baseline', value: (j) => j.baseline.savingVsBaseline, render: (j) => (j.baseline.isBaseline ? 'baseline' : formatEur(j.baseline.savingVsBaseline, { sign: true })), best: 'max' },
